            ...
            <div className="container mx-auto px-6 sm:px-8 lg:px-12">
                <div className={`backdrop-blur-md bg-[#0a0a0b]/80 border border-neutral-800/50 rounded-none sm:rounded-lg px-6 py-4 flex items-center justify-between transition-all duration-300 ${scrolled ? 'border-neutral-700/50' : ''}`}>
                    ...
                    <div className="hidden md:flex items-center gap-5 pl-6 border-l border-neutral-800">
                        <a href="https://github.com/kunjcr2" target="_blank" rel="noopener noreferrer" title="GitHub" className="text-neutral-500 hover:text-neutral-300 transition-colors"><Github size={18} /></a>
                        <a href="https://www.linkedin.com/in/kunjcr2/" target="_blank" rel="noopener noreferrer" title="LinkedIn" className="text-neutral-500 hover:text-neutral-300 transition-colors"><Linkedin size={18} /></a>
                        <a href="https://huggingface.co/kunjcr2" target="_blank" rel="noopener noreferrer" title="Hugging Face" className="text-neutral-500 hover:text-neutral-300 transition-colors"><HuggingFaceIcon size={18} /></a>
                        <a href="mailto:kunjcr2@gmail.com" title="Email" className="text-neutral-500 hover:text-neutral-300 transition-colors"><Mail size={18} /></a>
                    </div>
                    ...
                    {mobileMenuOpen && (
                        ...
                        >
                            ...
                            <div className="flex justify-center gap-6 mt-4 pt-4 border-t border-neutral-800">
                                <a href="https://github.com/kunjcr2" target="_blank" rel="noopener noreferrer" title="GitHub" className="text-neutral-500 hover:text-neutral-300"><Github size={20} /></a>
                                <a href="https://www.linkedin.com/in/kunjcr2/" target="_blank" rel="noopener noreferrer" title="LinkedIn" className="text-neutral-500 hover:text-neutral-300"><Linkedin size={20} /></a>
                                <a href="https://huggingface.co/kunjcr2" target="_blank" rel="noopener noreferrer" title="Hugging Face" className="text-neutral-500 hover:text-neutral-300"><HuggingFaceIcon size={20} /></a>
                                <a href="mailto:kunjcr2@gmail.com" title="Email" className="text-neutral-500 hover:text-neutral-300"><Mail size={20} /></a>
                            </div>
                        </motion.div>
                    )}
                </AnimatePresence>
